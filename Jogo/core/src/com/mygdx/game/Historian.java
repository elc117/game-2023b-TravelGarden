...
public class Historian implements Screen {
    final Drop game;
    ...
    public Historian(final Drop passed_game) {
        game = passed_game;
        ...
        backgroundTexture = new Texture(Gdx.files.internal("descubra.png")); // Carregue a textura do fundo
