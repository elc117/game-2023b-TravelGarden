...
public class Quiz2 extends ApplicationAdapter implements Screen{
    final Drop game;
    SpriteBatch batch;
    Texture img;
    BitmapFont font;
    ...
    public Quiz2 (final Drop passed_game) {
        game = passed_game;
        ...
        question = "O jardim botânico da UFSM é Órgão\n Suplementar do Centro de ...?";
        options = new String[]{"Centro de Ciências Naturais e Exatas (CCNE)", "Centro de Tecnologia (CT)", "Centro de Zoologia", "Centro de Ciências Sociais e Humanas (CCSH"};
        correctOption = 0;  
