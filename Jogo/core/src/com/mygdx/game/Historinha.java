...
public class Historinha implements Screen {
    final Drop game;
    ...
    public Historinha(final Drop passed_game) {
        game = passed_game;
        ...
        backgroundTexture = new Texture(Gdx.files.internal("ansiosa.png")); // Carregue a textura do fundo
        ...
        startButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new Historian (game));
                dispose();
            }
        });
